...
path_result = "runs/detect/exp9"  # yolov8识别结果
path_final_result = "runs/field" # 采摘点识别结果存储路径
path = "data/dataset/images/test3"  # 原始jpg图片
path3 = "runs/field/axis"  # 裁剪出来的小图保存的根目录
# w = 640                      # 原始图片resize
# h = 640
img_total = []
txt_total = []

old_path = "runs/detect/exp9/labels"   # txt读取路径
new_path = "data/dataset/images/test3" # 复制一份txt，并与原始图片放在一起
