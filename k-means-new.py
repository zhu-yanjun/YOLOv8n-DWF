...
image_path = []
all_images = []
images = os.listdir('./runs/detect/yolov8n-det-grape-+-dcn-ciou/predict/crops/define_img')
save_out = "E:/ZYJ/yolov8/ultralytics-main-detect/runs/detect/yolov8n-det-grape-+-dcn-ciou/predict/crops/kmeans/"

for image_name in images:
    image_path.append('./runs/detect/yolov8n-det-grape-+-dcn-ciou/predict/crops/define_img/' + image_name)
...
for labelID in labelIDs:
    ...
    cv2.imwrite(save_path, montage)   # 伽马变换  HSV
