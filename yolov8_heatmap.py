...
def get_params():
    params = {
        'weight': 'runs/segment/yolov8n-seg-g/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'HiResCAM',
        # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        # 'layer': [12, 15, 18, 21, 24, 27],               # yolov8n-seg-g-p2-mdinner-1.1_jiaohuan
        'layer': [12, 15, 18, 21],                 # yolov8n-seg-g
...
if __name__ == '__main__':
    ...
    model(r'G:\deep_learning\yolov8-main\dataset\images\test', 'result')
